...
const NormandySection = () => {
  return (
    <div className="max-w-[1400px] mx-auto px-6 lg:px-16 pb-6">
      <AnimatedSection>
        <div className="relative overflow-hidden rounded-2xl min-h-[420px] md:min-h-[300px] flex flex-col items-end justify-end">
          ...
          {/* Content */}
          <div className="relative z-10 max-w-sm p-6 md:p-8 text-right">
