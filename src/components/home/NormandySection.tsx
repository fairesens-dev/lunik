    ...
    <div className="max-w-[1400px] mx-auto px-6 lg:px-16 pb-6">
      <AnimatedSection>
        <div className="relative overflow-hidden rounded-2xl min-h-[420px] md:min-h-[300px] flex flex-col">
          ...
          />
          {/* Gradient overlay */}
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/60 md:bg-gradient-to-l md:from-black/60 md:to-transparent" />

          {/* Content - centered on mobile, right-third on desktop */}
          <div className="relative z-10 flex items-end md:items-center justify-center md:justify-end p-6 md:p-8 flex-1">
