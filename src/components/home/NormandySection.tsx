...
const NormandySection = () => {
  return (
    <div className="max-w-[1400px] mx-auto px-6 lg:px-16 py-1">
      <AnimatedSection>
        <div className="flex flex-col items-end mr-8 lg:mr-24">
          <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground font-medium">
            Fabriqué en <span className="text-primary">Normandie</span>
          </p>
          <div className="relative w-16 h-14 -mt-1">
            <svg viewBox="0 0 300 260" className="w-full h-full" fill="none">
              <path
                ...
                className="fill-primary/[0.08] stroke-primary/30"
                strokeWidth="2"
              />
              <circle cx="155" cy="120" r="8" className="fill-primary/40" />
              <circle cx="155" cy="120" r="3" className="fill-primary" />
            </svg>
          </div>
        </div>
      </AnimatedSection>
