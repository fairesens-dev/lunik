        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-card via-card to-primary/[0.06] border border-border/60 p-8 md:p-10">
          ...
          <div className="absolute right-4 md:right-10 top-1/2 -translate-y-1/2 w-40 md:w-56">
            <svg viewBox="0 0 300 260" className="w-full h-full" fill="none">
              ...
              />
              {/* Workshop marker */}
              <circle cx="155" cy="115" r="10" className="fill-accent/30" />
