...
const ConfiguratorCTASection = () => (
  <section id="configurator" className="py-28 lg:py-36 bg-[hsl(0,0%,10%)]">
    <div className="max-w-3xl mx-auto px-6 text-center">
      <AnimatedSection>
        ...
        <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight">
          Votre store en <span className="text-primary">quelques clics</span>
        </h2>
      ...
      <AnimatedSection delay={0.3}>
        <Link to="/configurateur">
          <Button variant="gradient" className="px-10 py-5 rounded-full tracking-[0.2em] uppercase text-sm font-medium h-auto shadow-lg hover:shadow-xl">
