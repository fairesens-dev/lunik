...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative min-h-[max(70vh,580px)] flex items-center justify-center -mt-20 overflow-hidden">
      ...
      {/* Content */}
      <div className={`relative z-10 max-w-[1400px] mx-auto px-6 lg:px-16 xl:px-24 w-full flex items-center justify-center min-h-[max(70vh,580px)] ${bannerActive ? "pt-[140px] md:pt-[180px]" : "pt-[100px] md:pt-[140px]"}`}>
