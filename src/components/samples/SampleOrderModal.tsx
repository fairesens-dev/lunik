...
const SampleOrderModal = ({ open, onOpenChange }: SampleOrderModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[700px] max-h-[90vh] flex flex-col p-0 gap-0 sm:rounded-xl">
        {/* Header */}
        ...
        {/* Footer */}
        <DialogFooter className="px-6 py-4 border-t border-[#e8e2d8] flex gap-2 sm:gap-2">
