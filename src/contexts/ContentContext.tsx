...
const defaultContent: SiteContent = {
  ...
  homepage: {
    ...
    testimonials: [
      { id: "t1", name: "M. Lesteven", city: "", text: "Produit de qualité, suivi commercial parfait, délai tenu.", rating: 5, active: true },
      { id: "t2", name: "M. Viet", city: "", text: "Très bonne entreprise, renseignements au top, store nickel, je recommande vivement.", rating: 5, active: true },
      { id: "t3", name: "M. Savorgnano", city: "", text: "Excellent contact avec l'équipe. Livraison rapide du produit qui correspond pleinement à nos attentes avec un prix raisonnable.", rating: 5, active: true },
      { id: "t4", name: "M. Demangeon", city: "", text: "Contact sympathique, efficacité des réponses.", rating: 5, active: true },
      { id: "t5", name: "Mme Rathgeber", city: "", text: "L'équipe est professionnelle, sympathique et travaille avec soin et propreté. Je recommande vivement !", rating: 5, active: true },
      { id: "t6", name: "Mme et M. Maire", city: "", text: "Nous avons commandé deux stores bannes chez Rayy. Nous sommes ravis et recommandons l'entreprise.", rating: 5, active: true },
      { id: "t7", name: "M. Adrian", city: "", text: "Je recommande cette entreprise. Livraison impeccable. Très bon produit et rendu impeccable.", rating: 5, active: true },
    ],
    faqItems: [],
    featuredReviews: [],
