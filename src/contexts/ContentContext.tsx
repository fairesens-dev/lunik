...
const defaultContent: SiteContent = {
  ...
  homepage: {
    ...
    testimonials: [
      { id: "t1", name: "Alain Laine", city: "", text: "Je recommande cette entreprise, rdv téléphonique : rappel en temps et en heure, très bien conseillé très pertinent sur les détails et composition du store, livraison avec personnel très serviable et enfin très bon produit très content de mon achat.", rating: 5, active: true },
      { id: "t2", name: "William", city: "", text: "Dès le premier contact je me suis senti rassuré par le professionnalisme de Baptiste, les conseils et le suivi de l'entreprise. Je recommande vraiment l'entreprise autant que pour l'accueil et la qualité et le prix.", rating: 5, active: true },
      { id: "t3", name: "Philippe", city: "", text: "Je recommande cette entreprise. Livraison impeccable. Vidéos de pose claire et explicite. Pose assez facile à réaliser. Très bon produit et rendu impeccable.", rating: 5, active: true },
      { id: "t4", name: "Pierrette Bourdon", city: "", text: "J'ai fait appel à Rayy grâce à mon fils qui avait fait appel à cette entreprise. Je ne peux qu'en dire du bien. Très professionnel, matériel de qualité. Explication donnée sur le fonctionnement et surtout sur l'attention à apporter au vent. Baptiste et son collègue extrêmement gentils. Tout a été parfait.", rating: 5, active: true },
    ],
    faqItems: [],
    featuredReviews: [],
