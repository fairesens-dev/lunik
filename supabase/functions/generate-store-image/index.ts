...
Key details:
- The awning fabric/canvas color is ${toileColorLabel} (${toileColorHex}). The fabric must clearly show this exact color.
- The aluminum frame/armature color is ${armatureColorLabel} (${armatureColorHex}). The frame must clearly show this exact color.
- ${ledInstruction}
- The awning is a premium cassette model with clean lines, the cassette housing is visible at the wall mount.
- Two folding arms support the fabric.
