...
<h1 style="margin:0;font-family:Georgia,serif;font-size:24px;color:#333;">Configuration sauvegardée !</h1>
</div>
<p style="font-size:14px;color:#555;line-height:1.6;">Retrouvez votre configuration ci-dessous. Cliquez sur le bouton pour la reprendre à tout moment.</p>
...
<tr><td style="padding:24px 32px;text-align:center;">
<p style="margin:0;font-size:12px;color:#8a7e6b;">Mon Store — Protection solaire sur-mesure</p>
</td></tr>
</table>
</td></tr></table>
</body></html>`;
    ...
    await resend.emails.send({
      ...
      to: [email],
      subject: "✅ Votre configuration de store sauvegardée",
      html,
    });
